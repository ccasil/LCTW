...
class Donations extends React.Component {
  ...
  constructor(props){
    ...
    change(event){    
      ...
      this.setState({value: event.target.value,  image: this.switchImage(event.target.value), vipimage: this.state.vipimage});
      console.log(this.state)
    }
    changeVIP(event){    
      console.log(event.target.value)
      this.setState({value: event.target.value, image: this.state.image, vipimage: this.switchImage(event.target.value)});
      console.log(this.state)
    }
      ...
      <div className="donations">
        ...
        <div className="cartItem">
          ...
          <table>
            ...
            <tr><td><input type="hidden" name="on1" value="Color"></input>Color</td></tr><tr><td><select name="os1" onChange={this.changeVIP} value ={this.state.value}>
