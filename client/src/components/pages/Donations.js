    ...
    return (
      <div className="donations">
        ...
        <div className="donatebuttons">
          ...
          <form action="https://www.gofundme.com/hurricane-harvey-refuge-donations" target="_blank">
            <input type="submit" className="btn btn-success buttonspace" value="GoFundMe" />
          </form>
        </div>
