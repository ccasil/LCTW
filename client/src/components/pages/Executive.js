  ...
  render() {
    return <div className="executive">
      ...
      <div className="container-fluid">
        ...
        <div className="row align-items-start about">
            <div className="col col-lg-4 col-md-12 col-sm-12 text-center">
            <img className="executive" src={executive} height="200px;" alt="executive" />
            </div>
            <div className="col col-lg-8 col-md-12 col-sm-12">
        ...
        <div className="row align-items-start about">
          <div className="col col-lg-4 col-md-12 col-sm-12 text-center">
            <img className="executive" src={graphics} height="200px;" alt="executive" />
          </div>
          <div className="col col-lg-8 col-md-12 col-sm-12">
        ...
        <div className="row align-items-start about">
          <div className="col col-lg-4 col-md-12 col-sm-12 text-center">
            <img className="executive" src={ceo} height="200px;" alt="executive" />
          </div>
          <div className="col col-lg-8 col-md-12 col-sm-12">
            <h2 className="display-4">Sister PlaceHolder</h2>
