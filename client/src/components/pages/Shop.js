  ...
  render() {
    return (
      <div className="donations">
        ...
        Thank you for your generous HEARTS! We LOVE you ALL!!! VIP items are for VIP members only.
        ...
        <div className="new">
          <div className="cartItem">
            ...
            <div className="regularItem">
              <img alt="shirt" className="shoppingImg" src={VIPApron1}></img>
            </div>
          </div>
          <div className="cartItem">
            <h2>Whats Hot!!!</h2>
        ...
        <div className="cartItem">
          ...
          <h4> LCTW TankTops </h4>
          <div className="newItem">
            <img alt="shirt" className="shoppingImg" src={TankTop}></img>
          </div>
        ...
        <div className="cartItem">
          ...
          <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" className="cartForm">
          <input type="hidden" name="cmd" value="_cart"></input>
          <input type="hidden" name="business" value="info@lovechangingtheworld.com"></input>
          <input type="hidden" name="lc" value="US"></input>
          <input type="hidden" name="item_name" value="Love Changing the World - Shirt"></input>
          <input type="hidden" name="button_subtype" value="products"></input>
          <input type="hidden" name="no_note" value="0"></input>
          ...
          <table>
            ...
            <tr><td><input type="hidden" name="on1" value="Color"></input>Color</td></tr><tr><td><select name="os2" onChange={this.changeVIP} value ={this.state.value}>
              ...
              <option value="Black - Silver">Black - Platinum </option>
              <option value="Red - Gold">Red - Gold </option>
              <option value="Red - Silver">Red - Platinum </option>
        ...
        <div className="cartItem">
          ...
          <div className="regularItem">
            <img alt="vipshirt" className="shoppingImg" src={this.state.viptank}></img>
          </div>
          ...
          <table>
            ...
            <tr><td><input type="hidden" name="on1" value="Color"></input>Color</td></tr><tr><td><select name="os2"  onChange={this.changeVIPTank} value ={this.state.value}>
              <option value="VIP Tank Top - Gold">Gold </option>
              <option value="VIP Tank Top - Platinum">Platinum </option>
          ...
          <p> If you would like a VIP TankTop, please use the contact us page.</p>
          </form>
          <div className="line"></div>
        ...
        <div className="cartItem">
          ...
          <div className="newItem">
            <img alt="vipshirt" className="shoppingImg" src={this.state.vipapron}></img>
          </div>
          ...
          <table>
            ...
            <tr><td><input type="hidden" name="on1" value="Color"></input>Color</td></tr><tr><td><select name="os2" onChange={this.changeVIPApron} value ={this.state.value}>
              <option value="VIP Apron - Red Text">Black - Red </option>
              <option value="VIP Apron - Silver Text">Black - Silver </option>
          ...
          <p> If you would like a VIP Apron, please use the contact us page.</p>
          </form>
          <div className="line"></div>
