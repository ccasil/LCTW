...
import BlackGreenHoodie from "../../images/Shop/LOVE_7.jpeg";
import BlackGreen from "../../images/Shop/LOVE_8.jpeg";
import Green from "../../images/Shop/LOVE_9.jpeg";
...
class Donations extends React.Component {
  ...
  change(event) {
    ...
    this.setState({
      ...
      image: this.switchImage(event.target.value)
    });
  ...
  changeVIP(event) {
    ...
    this.setState({
      value: event.target.value,
      vipimage: this.switchImage(event.target.value)
    });
    console.log(this.state);
  }
  changeApron(event) {
    ...
    this.setState({
      value: event.target.value,
      apron: this.switchImage(event.target.value)
    });
    console.log(this.state);
  }
  changeVIPApron(event) {
    ...
    this.setState({
      value: event.target.value,
      vipapron: this.switchImage(event.target.value)
    });
    console.log(this.state);
  }
  changeVIPTank(event) {
    this.setState({
      value: event.target.value,
      viptank: this.switchImage(event.target.value)
    });
  }
  ...
  switchImage(param) {
    ...
    switch (param) {
      ...
      case "White Shirt - Black Text":
        return WhiteBlack;
      case "Green Shirt - Red Text":
        return Green;
      case "Green Shirt - Black Text":
        return Green;
      case "Black - Gold":
        return VIP1;
      case "Black - Silver":
  ...
  render() {
    return (
      <div className="donations">
        ...
        <div className="shoparea">
          <div className="cartItem">
            <h4> T-LIMITED EDITION!!! Saint Patrick's Day T-Shirts </h4>
            <div className="regularItem">
              <img
                alt="shirt"
                className="shoppingImg"
            ...
            >
              ...
              <input
                type="hidden"
                name="item_name"
                value="Love Changing the World - Shirt"
              />
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        >
                          <option value="Green Shirt - Red Text">
                            Green - Red Text{" "}
                          </option>
                          <option value="Green Shirt - Black Text">
                            Green - Black Text{" "}
                          </option>
                        </select>{" "}
                      </td>
          ...
          <div className="cartItem">
            <h4>LIMITED EDITION!!! Saint Patrick's Day T-Shirts</h4>
            <div className="regularItem">
              <img alt="shirt" className="shoppingImg" src={BlackGreen} />
            </div>
            ...
            >
              ...
              <input
                type="hidden"
                name="item_name"
                value="Saint Patrick's Day T-Shirt"
              />
              <input type="hidden" name="button_subtype" value="products" />
              <input type="hidden" name="no_note" value="0" />
              <input type="hidden" name="shipping" value="5.00" />
          ...
          <div className="cartItem">
            <h4> LIMITED EDITION!!! Saint Patrick's Day Hoodies </h4>
            <div className="regularItem">
              <img
                alt="hoody"
                className="shoppingImg"
                src={BlackGreenHoodie}
              />
            </div>
            ...
            >
              ...
              <input
                type="hidden"
                name="item_name"
                value="Saint Patrick's Day Green Hoody"
              />
              <input type="hidden" name="button_subtype" value="products" />
              <input type="hidden" name="no_note" value="0" />
              <input type="hidden" name="shipping" value="5.00" />
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <select name="os1">
                          <option value="Green Hoody">Green Hoody</option>
                        </select>{" "}
                      </td>
                    </tr>
                  </tbody>
          ...
          <div className="cartItem">
            ...
            >
              ...
              <input
                type="hidden"
                name="item_name"
                value="Breast Cancer Awareness T-Shirt"
              />
              <input type="hidden" name="button_subtype" value="products" />
              <input type="hidden" name="no_note" value="0" />
              <input type="hidden" name="shipping" value="5.00" />
            ...
            >
              <div className="ShoppingOptions">
                ...
                <input
                  type="hidden"
                  name="option_select0"
                  value="White Apron - Red Text"
                />
                <input type="hidden" name="option_amount0" value="25.00" />
                <input
                  type="hidden"
                  name="option_select1"
                  value="White Apron - Black Text"
                />
                <input type="hidden" name="option_amount1" value="25.00" />
                <input
                  type="hidden"
                  name="option_select2"
                  value="Black Apron - Red Text"
                />
                <input type="hidden" name="option_amount2" value="25.00" />
                <input
                  type="hidden"
                  name="option_select3"
                  value="Black Apron - White Text"
                />
                <input type="hidden" name="option_amount3" value="25.00" />
                <input type="hidden" name="option_index" value="0" />
              </div>
          ...
          <div className="cartItem">
            ...
            >
              ...
              <input
                type="hidden"
                name="item_name"
                value="Love Changing the World - Hoody"
              />
              <input type="hidden" name="button_subtype" value="products" />
              <input type="hidden" name="no_note" value="0" />
              <input type="hidden" name="shipping" value="5.00" />
          ...
          <div className="cartItem">
            ...
            >
              ...
              <p>
                {" "}
                If you would like this item, please support us by visiting
                the{" "}
                <Link
                  to="/membership"
                  onClick={() => window.scrollTo(0, 0)}
          ...
          <div className="cartItem">
            ...
            <p>
              {" "}
              If you would like this item, please support us by visiting the{" "}
