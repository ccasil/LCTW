        ...
        return (
            <div>
                ...
                <ul className="list-unstyled">
                    ...
                    <li><span className="font-weight-bold">National Domestic Violence Hotline (for support, resources and advice for safety regarding abuse):</span><a href="http://www.thehotline.org/" target="_blank" rel="noopener noreferrer" className="d-line">thehotline.org</a> 1 (800) 799-SAFE </li>
                ...
                <p className="h4">New Mission Community Church <small class="text-muted">(NMCC)</small></p>
