...
class Navbar extends Component {
  ...
  render() {
    ...
    const loggedoutLinks = <ul className="navbar-nav mx-auto text-center">
        <li className="nav-item">
        ...
        <div className="textmargin">
          ...
          <div id="buttonspace" className="d-inline">
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
              ...
              <input type="hidden" name="item_name" value="Love Changing the World" />
          ...
          <div className="collapse navbar-collapse justify-content-between align-items-center w-100" id="navbarNavDropdown">
            <ul className="navbar-nav mr-auto text-center">
              ...
              <li className="nav-item dropdown navbar-logo mx-auto">
                <a className="nav-link dropdown-toggle" tabIndex="0" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Meet Our Board
                </a>
